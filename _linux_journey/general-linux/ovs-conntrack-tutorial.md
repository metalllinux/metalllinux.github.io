---
title: "Definitions[¶](#definitions 'Link to this heading')"
category: "general-linux"
tags: ["ovs", "conntrack", "tutorial"]
---
...
## Sample Topology[¶](#sample-topology "Link to this heading")
...
## Tool used to generate TCP segments[¶](#tool-used-to-generate-tcp-segments "Link to this heading")
...
## Matching TCP packets[¶](#matching-tcp-packets "Link to this heading")

### TCP Connection setup[¶](#tcp-connection-setup "Link to this heading")
...
### TCP Data[¶](#tcp-data "Link to this heading")
...
### TCP Connection Teardown[¶](#tcp-connection-teardown "Link to this heading")
...
### Flows[¶](#flows "Link to this heading")
