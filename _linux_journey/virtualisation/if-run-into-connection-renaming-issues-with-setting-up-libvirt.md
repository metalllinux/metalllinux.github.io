...
[myuser@myhost-rocky-linux-9 ~]$ sudo nmcli connection add type bridge-slave autoconnect yes con-name "Wired connection 1" ifname "Wired connection 1" master virbr0
...
[myuser@myhost-rocky-linux-9 ~]$ sudo nmcli connection add type bridge-slave autoconnect yes con-name "enp2s0" ifname "enp2s0" master virbr0
