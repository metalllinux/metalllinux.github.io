...
tags: ["kubernetes-and-containers", "kubectl", "delete", "kubernetes"]
---
...
| \-k, --kustomise string |     |
|     | Process a kustomisation directory. This flag can't be used together with -f or -R. |
| \--now |     |
...
| \-R, --recursive |     |
|     | Process the directory used in -f, --filename recursively. Useful when you want to manage related manifests organised within the same directory. |
| \-l, --selector string |     |
...
- [kubectl](https://kubernetes.io/docs/reference/kubectl/generated/kubectl_delete/../kubectl/) - kubectl controls the Kubernetes cluster manager
...
Last modified August 19, 2024 at 5:14 PM PST: [Update kubectl reference for v1.31 (59df28c340)](https://github.com/kubernetes/website/commit/59df28c34043443883c1e20503ffc1f70d61b9f3)

[Create documentation issue](https://github.com/kubernetes/website/issues/new?title=kubectl%20delete) [(auto-generated page)](#auto-generated-edit-notice) <a id="print"></a>[Print entire section](https://kubernetes.io/docs/reference/kubectl/generated/kubectl_delete/_print/)
...
© 2024 The Linux Foundation ®. All rights reserved. The Linux Foundation has registered trademarks and uses trademarks. For a list of trademarks of The Linux Foundation, please see our [Trademark Usage page](https://www.linuxfoundation.org/trademark-usage)
