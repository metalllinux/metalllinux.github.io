...
tags: ["kubernetes-and-containers", "gateway", "api", "kubernetes"]
---
...
-   **Extensible:** Gateway allows for custom resources to be linked at various layers of the API. This makes granular customisation possible at the appropriate places within the API structure.
