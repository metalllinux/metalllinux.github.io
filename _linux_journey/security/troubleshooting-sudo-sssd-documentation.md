---
title: "Troubleshooting SUDO"
category: "security"
tags: ["security", "troubleshooting", "sudo", "sssd", "documentation"]
---
...
# [SSSD](https://docs.pagure.org/sssd.sssd/users/../index.html)

### Navigation

- [Newcomers Guide](https://docs.pagure.org/sssd.sssd/users/../newcomers/index.html)
- [User facing documentation](https://docs.pagure.org/sssd.sssd/users/index.html)
    - [Integrating with a Windows server using the AD provider](https://docs.pagure.org/sssd.sssd/users/ad_provider.html)
    - [Integrating with a Windows server using the LDAP provider](https://docs.pagure.org/sssd.sssd/users/ldap_with_ad.html)
    - [Frequently Asked Questions](https://docs.pagure.org/sssd.sssd/users/faq.html)
    - [Debugging and troubleshooting SSSD](https://docs.pagure.org/sssd.sssd/users/troubleshooting.html)
    - [Troubleshooting SUDO](#)
    - [Migrating from pam_krb5 to sssd](https://docs.pagure.org/sssd.sssd/users/pam_krb5_migration.html)
    - [How to file a useful SSSD bug report](https://docs.pagure.org/sssd.sssd/users/reporting_bugs.html)
    - [SSSD Releases](https://docs.pagure.org/sssd.sssd/users/releases.html)

- [External documentation about SSSD](https://docs.pagure.org/sssd.sssd/users/../external/index.html)

- [Developer documentation](https://docs.pagure.org/sssd.sssd/users/../developers/index.html)

- [SSSD feature design pages](https://docs.pagure.org/sssd.sssd/users/../design_pages/index.html)

### Quick search

©2017, SSSD developers. | Powered by [Sphinx 1.8.4](http://sphinx-doc.org/) & [Alabaster 0.7.12](https://github.com/bitprophet/alabaster) | [Page source](https://docs.pagure.org/sssd.sssd/users/../_sources/users/sudo_troubleshooting.rst.txt)