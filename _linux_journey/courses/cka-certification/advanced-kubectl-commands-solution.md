---
title: "Advanced Kubectl Commands Solution"
category: "cka-certification"
tags: ["cka-certification", "advanced", "kubectl", "commands", "solution"]
---
...
```
Use the command kubectl get nodes -o=jsonpath='{.items[*].metadata.name}' > /opt/outputs/node_names.txt
```
