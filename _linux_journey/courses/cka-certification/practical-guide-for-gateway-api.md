---
title: "Practical Guide For Gateway Api"
category: "cka-certification"
tags: ["cka-certification", "practical", "guide", "gateway", "api"]
---
...
To install the NGINX Gateway Controller, run the following commands:
    ...
    kubectl kustomise "https://github.com/nginx/nginx-gateway-fabric/config/crd/gateway-api/standard?ref=v1.6.2" | kubectl apply -f -
     
    kubectl kustomise "https://github.com/nginx/nginx-gateway-fabric/config/crd/gateway-api/experimental?ref=v1.6.2" | kubectl apply -f -
