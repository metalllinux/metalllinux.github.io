...
tags: ["kernel-and-system-internals", "tuning", "real", "time", "kernel"]
---
...
- [Products](https://ubuntu.com/navigation#products-navigation)
- [Use cases](https://ubuntu.com/navigation#use-case-navigation)
- [Support](https://ubuntu.com/navigation#support-navigation)
- [Community](https://ubuntu.com/navigation#community-navigation)
- [Get Ubuntu](https://ubuntu.com/navigation#get-ubuntu-navigation)

- [Sign in](https://ubuntu.com/login)
- [](https://ubuntu.com/search)

<img width="18" height="18" src="../_resources/82818827-CoF_white_bf06201f21714649ae263fef11cc34a-1.svg"/><br>Blog](https://ubuntu.com/blog)

- [Internet of Things](https://ubuntu.com/blog/internet-of-things)
- [Desktop](https://ubuntu.com/blog/desktop)
- [Cloud and Server](https://ubuntu.com/blog/cloud-and-server)
- [Web and Design](https://ubuntu.com/blog/topics/design)
- [People and culture](https://ubuntu.com/blog/people-and-culture)

# Tuning a real-time kernel

<img width="54" height="54" src="../_resources/ef337f5619a290e427b5e5aea7eca015_8bf04e1ab4a74be8b-1.png"/>

### [Edoardo Barbieri](https://ubuntu.com/blog/author/edoardo-barbieri "More about Edoardo Barbieri")

on 19 June 2023

- Share on:
- [Facebook](https://www.facebook.com/sharer/sharer.php?u=https://www.ubuntu.com/blog/real-time-kernel-tuning "Share on Facebook")
- [Twitter](https://twitter.com/share?text=Tuning%20a%20real-time%20kernel&url=https://www.ubuntu.com/blog/real-time-kernel-tuning&hashtags=ubuntu "Share on Twitter")
- [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.ubuntu.com/blog/real-time-kernel-tuning&title=Tuning%20a%20real-time%20kernel "Share on LinkedIn")

**Tags:** [Industrial](https://ubuntu.com/blog/tag/industrial) , [real-time Linux](https://ubuntu.com/blog/tag/real-time-linux)

![](../_resources/RTK-WP-Blog-Banner-grey_c5cb3fd85ee14ab7af759e2c33-1.png)

[Read the whitepaper now](https://ubuntu.com/engage/cto-guide-real-time-kernel)

This blog expands our  [technical deep-dive into a real-time kernel](https://ubuntu.com/blog/real-time-kernel-technical).  You will need to be familiar with a real-time kernel to understand the tuning concepts in this blog. If you are starting from scratch and need to revisit the basics of preemption and a real-time system, watch this [introductory webinar](https://ubuntu.com/engage/an-introduction-to-real-time-linux-part-i). If you are interested in the primary test suites for [Real-time Ubuntu](https://ubuntu.com/real-time), an explanation of the components and processes involved, head over to [the first part](https://ubuntu.com/blog/real-time-kernel-technical) of this mini-series. Alternatively, keep reading to learn the three primary metrics to monitor when tuning a real-time kernel, some key configs set at compile time, and a tuning example.  

Before tuning, let’s launch the [real-time Ubuntu kernel](https://ubuntu.com/real-time).  

## Launching the real-time kernel

Canonical’s real-time kernel can be accessed through [Ubuntu Pro](https://ubuntu.com/pro), an extensive enterprise security and compliance subscription (free for personal and small-scale commercial use on up to 5 machines). With an [Ubuntu Pro subscription](https://ubuntu.com/pro/dashboard), launching the kernel becomes a simple process:
...
To access [Real-time Ubuntu](https://ubuntu.com/real-time) on Intel SoCs, [Ubuntu Pro](https://ubuntu.com/pro/dashboard) is also the way to go:
...
![](../_resources/vX1M3FKvY2KVKRBfZVaQlF1AZKA7k9pb_f08209c660c84c889-1.png)
...
Performance strictly depends on the system at hand. However, a good rule of thumb for the maximum latency of a real-time Linux system is around 100 μs. On the other hand, [Real-time Ubuntu](https://ubuntu.com/real-time) with a few changes to boot parameters can result in an average latency of 2-3 μs and max latency dropping considerably, with all values well under 100 μs.  
...
### [Talk to us about real-time Ubuntu](https://ubuntu.com/kernel/real-time/contact-us)
...
<a id="canonicalUpdatesOptIn"></a>\*I agree to receive information about Canonical’s products and services.
...
#### [Canonical releases Real-time Ubuntu 24.04 LTS](https://ubuntu.com/blog/real-time-24-04)
...
#### [Real-time Linux vs RTOS – Part II](https://ubuntu.com/blog/real-time-linux-vs-rtos-2)
...
#### [Real-time Linux vs RTOS – Part I](https://ubuntu.com/blog/real-time-linux-vs-rtos)
...
## [Managed Services](https://ubuntu.com/managed)
...
- <a id="report-a-bug"></a>[Report a bug on this site](https://github.com/canonical/ubuntu.com/issues/new?body=%0a%0a%0a---%0a*Reported%20from:%20https://ubuntu.com/blog/real-time-kernel-tuning*)
