...
tags: ["rocky-linux", "setup", "kubernetes", "rocky", "linux"]
---

```
# Add IPs of all hosts to each /etc/hosts file
sudo tee /etc/hosts <<EOF
192.168.1.23	rocky-linux-95-kubernetes-ansible
EOF
...
sudo kubeadm init --control-plane-endpoint=rocky-linux-95-kubernetes-ansible
