---
title: "Package Install - Not Recommended"
category: "rocky-linux"
tags: ["rocky-linux", "setting", "keepalived", "load", "balancing"]
---
...
```
cat << "EOF" | sudo tee /usr/local/sbin/virtual_ip_setup.sh
_VIP=10.25.96.10
case $1 in
    start)
