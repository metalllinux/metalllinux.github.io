---
title: "Contents[](#contents 'Permalink to this heading')"
category: "rocky-linux"
tags: ["rocky-linux", "install", "openzfs", "rhel", "based"]
---
...
[DKMS](https://en.wikipedia.org/wiki/Dynamic_Kernel_Module_Support) and [kABI-tracking kmod](https://elrepoproject.blogspot.com/2016/02/kabi-tracking-kmod-packages.html) style packages are provided for x86_64 RHEL- and CentOS-based distributions from the OpenZFS repository. These packages are updated as new versions are released. Only the repository for the current minor version of each current major release is updated with new packages.
...
**Current release packages:** [EL7](https://zfsonlinux.org/epel/zfs-release-2-3.el7.noarch.rpm), [EL8](https://zfsonlinux.org/epel/zfs-release-2-3.el8.noarch.rpm), [EL9](https://zfsonlinux.org/epel/zfs-release-2-3.el9.noarch.rpm)
...
## DKMS[](#dkms "Permalink to this heading")
...
## kABI-tracking kmod[](#kabi-tracking-kmod "Permalink to this heading")
...
## Previous minor EL releases[](#previous-minor-el-releases "Permalink to this heading")
...
## Testing Repositories[](#testing-repositories "Permalink to this heading")
...
## Root on ZFS[](#root-on-zfs "Permalink to this heading")
