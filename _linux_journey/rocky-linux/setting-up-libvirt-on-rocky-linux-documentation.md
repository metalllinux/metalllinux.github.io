---
title: "Setting Up Libvirt On Rocky Linux Documentation"
...
[libvirt](https://libvirt.org/) is an incredible virtualisation API that allows for the virtualisation of almost any operating system of your choice with the power of KVM as the hypervisor, and QEMU as the emulator.
...
* Ensure the enabling of virtualisation in your BIOS settings. If the following command returns output, that means enabling of virtualisation is complete:
