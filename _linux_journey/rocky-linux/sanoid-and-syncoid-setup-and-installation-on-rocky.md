...
#!/bin/bash
syncoid -r myuser@192.168.1.x:server-a/anime server-b/anime
syncoid -r myuser@192.168.1.x:server-a/bitcoin server-b/bitcoin
syncoid -r myuser@192.168.1.x:server-a/media-d server-b/media-d
syncoid -r myuser@192.168.1.x:server-a/media-b server-b/media-b
syncoid -r myuser@192.168.1.x:server-a/documents server-b/documents
syncoid -r myuser@192.168.1.x:server-a/ebooks server-b/ebooks
syncoid -r myuser@192.168.1.x:server-a/films server-b/films
syncoid -r myuser@192.168.1.x:server-a/games server-b/games
syncoid -r myuser@192.168.1.x:server-a/gaming_videos server-b/gaming_videos
syncoid -r myuser@192.168.1.x:server-a/isos server-b/isos
syncoid -r myuser@192.168.1.x:server-a/linux server-b/linux
syncoid -r myuser@192.168.1.x:server-a/media-c server-b/media-c
syncoid -r myuser@192.168.1.x:server-a/music server-b/music
syncoid -r myuser@192.168.1.x:server-a/media-a server-b/media-a
syncoid -r myuser@192.168.1.x:server-a/shows server-b/shows
syncoid -r myuser@192.168.1.x:server-a/media-e server-b/media-e
syncoid -r myuser@192.168.1.x:server-a/software server-b/software
EOF
```
