---
title: "Setting Up A Pxe Server On Rocky Linux 9.X"
category: "rocky-linux"
tags: ["rocky-linux", "setting", "pxe", "server", "rocky"]
---
...
label <your_label_here>
  kernel <distro_name_here>/vmlinuz
  append initrd=distro_name_here/initrd.img method=http://<server_ip>/<distro_name_here>/os/ devfs=nomount
```
...
```
virt-install --hvm --connect qemu:///system --name testvm --ram 4096 --vcpus 4 --network=bridge:virbr0 --pxe --osinfo detect=on,require=off --disk path=/home/myuser/images/testvm.qcow2,size=20 --graphics vnc
```
