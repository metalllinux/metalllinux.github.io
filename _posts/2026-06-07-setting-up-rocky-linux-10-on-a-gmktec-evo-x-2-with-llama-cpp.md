...
What I want to explore next is the practical day-to-day value this hardware can deliver. Some of the stuff I want to check out is: accelerating documentation writing, supporting software development with a capable coding assistant, helping plan and research woodworking projects, and supporting home automation — but I suspect the real gains will only become clear through sustained use. I want to try more models on this hardware, understand what each brings to different kinds of work, and find out where the limits actually are. The unified memory architecture and the GPU compute available here feel like they have more to give, and I intend to find out just how far they go.
